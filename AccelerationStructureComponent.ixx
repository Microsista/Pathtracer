...
public:
    ...
    void BuildAccelerationStructures() {
       ...
       // LoadDDSTexture(device, commandList, s.c_str(), descriptorHeap, stoneTexture[0].resource.GetAddressOf(), stoneTexture[0].upload.GetAddressOf(), &stoneTexture[0].heapIndex, &stoneTexture[0].cpuDescriptorHandle,
         //   &stoneTexture[0].gpuDescriptorHandle, D3D12_SRV_DIMENSION_TEXTURE2D);
